...
int main()
{
	...
	//
	cout << boolalpha;
	cout << "IsRoute 4 and 2: " << isRoute(graph, vector, 4, 2) << endl;
	cout << "IsRoute 5 and 1: " << isRoute(graph, vector, 5, 1) << endl;
	cout << "IsRoute 6 and 5: " << isRoute(graph, vector, 6, 5) << endl;
	cout << "IsRoute 0 and 1: " << isRoute(graph, vector, 0, 1) << endl;
	cout << "IsRoute 3 and 5: " << isRoute(graph, vector, 3, 5) << endl;
